          ...
          <div>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  방송하면서 앱에서 사용할 수 있는 여러 에셋을 제어하고 관리할
                  수 있는 에셋 페이지
                </li>
              </ul>
              <p>
                계정 정보 및 구독 상태를 볼 수 있는 계정 페이지 프로젝트
                설계부터 디자인, 개발을 맡았습니다.
              </p>
              <ul>
                ...
                <li>
                  Mui와 styled-components를 결합하여 커스텀 글로벌 테마 제작
                </li>
            ...
            >
              ...
              <ul>
                <li>
                  범용, 야구, 축구, 농구, 탁구 스코어보드 및 각 스코어보드에
                  맞는 컨트롤러
                </li>
                <li>
                ...
                <li>
                  CustomCSS를 제공하여 사용자가 스코어보드 및 타이머를 커스텀할
                  수 있게 제공
                </li>
                <li>시계, 스톱워치, 타이머 및 각 컨트롤러</li>
                <li>
                  시계 포맷 변경 및 일반적인 스톱워치 및 타이머 기능 제어
                  컨트롤러 제공
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  BroadcastChannel을 이용하여 컨트롤러와 뷰어를 분리하여 다른
                  탭에서 스코어보드 및 타이머를 조작할 수 있도록 제작
                </li>
            ...
            >
              <p>
                대선 관련 정보를 모아 볼 수 있는 웹페이지를 제작 프로젝트
                입니다.
              </p>
              <ul>
                <li>로그인, 로그아웃, 회원가입 기능</li>
                <li>
                  오늘의 주요 뉴스와 대선까지 남은 디데이, 주요 일정을 보여주는
                  메인 페이지
                </li>
                <li>
                ...
                <li>
                  대선 관련 최신 뉴스 제공 및 후보와 관련된 뉴스만 모아 볼 수
                  있는 필터링 기능을 제공하는 선거 뉴스 페이지
                </li>
                <li>
                  현재까지 진행된 여론 조사 결과를 차트로 보여주는 여론조사
                  페이지
                </li>
              ...
              <ul>
                ...
                <li>
                  opengraph 메타데이터를 이용하여 네이버 뉴스 API에서 받아온
                  링크의 미리보기 컴포넌트 제작
                </li>
                <li>
                  주요 후보와 관련 있는 기사만 모아 볼 수 있는 필터링 제작
                </li>
                <li>선거 뉴스 페이지 제작</li>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  텍스트 인식 후 제대로 인식했는지 확인하는 과정 및 사용자가
                  수락을 하면 바이오인증 후 송금
                </li>
                <li>
                ...
                <li>
                  은행명, 계좌번호, 받는 사람 이름을 저장할 수 있는 연락처
                  페이지
                </li>
                <li>
                  이름, 이메일, 계좌번호 정보를 볼 수 있으며 로그아웃을 할 수
                  있는 내 정보 페이지
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  사용자 이름 등을 정규표현식을 통해 인식하여 알맞은 함수를
                  호출하여 동작하게 제작
                </li>
                <li>
                  텍스트를 인식한 후 챗봇이 입력한 정보를 정리하여 제대로
                  인식하였는지 사용자에게 확인한 후 사용자가 수락을 하면
                  스마트폰의 생체인증 및 비밀번호를 이용하여 인증을 한 뒤 송금
                  API를 호출하여 송금하도록 제작
                </li>
                <li>
                  연락처 페이지를 제작하여 사용자가 미리 은행명, 계좌번호, 받는
                  사람 이름을 저장하여 채팅 페이지에서 등록되어 있는 받는 사람
                  이름만 입력하면 저장되어 있는 정보를 불러와 송금하도록 하도록
                  제작
                </li>
              </ul>
              <p>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  이전 프로젝트에서 사용하였던 Ant design과 같이 라이브러리
                  대신에 직접 컴포넌트를 제작하여 사용
                </li>
                <li>
                  Atomic 디자인을 적용하여 atoms, molecules, organisms,
                  tempaltes 폴더로 컴포넌트를 나눠 컴포넌트 재활용을 최대한 적용
                </li>
                <li>
                ...
                <li>
                  워드의 특정 라인이나 엑셀의 특정 셀을 선택하였을 때 강조
                  표시하기 및 커멘트 달기 등의 팝오버 창을 띄우고 기능 제작
                </li>
                <li>
            ...
            >
              ...
              <ul>
                <li>
                  JS, HTML, CSS 지식 습득 및 프로젝트에서 발생한 오류를 수정
                </li>
                <li>
                  React를 배우면서 프로젝트를 병행하였고 테이블 컴포넌트가
                  사용된 페이지의 성능 개선 및 정렬 기능 추가
                </li>
                <li>
