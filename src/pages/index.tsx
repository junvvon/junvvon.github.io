...
import AboutContentLayout from "../components/AboutContentLayout";
import BigParagraph from "../components/BigParagraph";
import Row from "../components/Row";
import Project from "../components/Project";
import OutLink from "../components/OutLink";
import SideListLayout from "../components/SideListLayout";
        ...
        <AboutContentLayout>
          ...
          >
            <Project
              description={
                <p>
                  ...
                  />
                  를 제작 프로젝트입니다. 커뮤니티 페이지, 스코어보드 관리
                  페이지 및 계정 정보 및 구독 상태를 볼 수 있는 계정 페이지
                  프로젝트 설계부터 디자인, 개발을 맡았습니다.
                </p>
              }
            ...
            <Project
              description={
                <p>
                  회사 내에서 사용하는 서비스 관리 페이지입니다. 사용자 관련
                  통계 페이지 및 사용자 관리, 공지 관리 기능을 하고 있습니다.
                </p>
              }
            ...
            >
              <ul>
                ...
                <li>
                  데이터 삭제, 수정 기능이 있는 재사용 가능한 테이블 컴포넌트
                  개발
                </li>
              </ul>
            </Project>
            ...
            <Project
              description={
                <p>
                  ...
                  기능이 있는 웹페이지 제작 프로젝트입니다. 프로젝트 기획,
                  디자인, 개발 전 과정에 참여하였습니다. Antd를 사용했던 이전
                  프로젝트와 달리 모든 컴포넌트를 직접 디자인 개발하였습니다.
                </p>
              }
          ...
          >
            <Project
              description={
                <p>
                  한양대학교 소프트웨어스튜디오2 수업 과제로 대선 관련 정보를
                  모아 볼 수 있는 웹페이지를 제작 프로젝트 입니다. 팀원 4명이서
                  진행하였으며 팀장을 맡아 기획, 디자인 개발 등 전 과정을
                  담당하였습니다.{" "}
                  {/* <Link to="/posts/daesun" target="_blank">
                    자세히 보기
                  </Link> */}
                </p>
              }
          ...
          <Project
            description={
              <p>
                ...
                못하였습니다.{" "}
                {/* <Link to="/posts/onelinebank" target="_blank">
                  자세히 보기
                </Link> */}
              </p>
            }
          ...
          <Project
            description={
              <p>
                ...
                {/* <Link to="/posts/next-blog" target="_blank">
                  자세히 보기
                </Link> */}
              </p>
            }
